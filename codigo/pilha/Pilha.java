/**
 * Pacote que contem a estrutura de dados Pilha
 */
package pilha;
...
{
	/**
	 * Atributo que representa a posicao do ultimo valor do vetor {@link Pilha#elemento}
	*/
	protected int topo;
	/**
	 * Vetor onde será guardado os objetos da pilha
	*/
	protected Object[] elemento;
	/**
	 * Taxa de crescimento (em porcentagem) do vetor {@link Pilha#elemento}
	*/
